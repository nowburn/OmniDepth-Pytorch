...
class OmniDepthTrainer(object):
    ...
    def train_one_epoch(self):
        ...
        for batch_num, data in enumerate(self.train_dataloader):
            ...
            # Every few batches
            if batch_num % self.visualization_freq == 0 or batch_num == max_batch_num:
                # Visualize the loss
    ...
    def print_progress(self, batch_num, max_batch_num, batch_size, loss, max_arrow=50):
        self.i = (batch_num + 1) * batch_size if batch_num < max_batch_num else self.num_samples
        num_arrow = int(self.i * max_arrow / self.num_samples)  # 计算显示多少个'>'
